...
public class TransparentWindow : MonoBehaviour
{
    ...
    /// Layered 속성을 가진 창의 세부 속성을 설정하는 함수
    ...
    static readonly IntPtr HWND_NOTOPMOST = new IntPtr(-1); // 화면 Z-순서 가장 상단에 위치하도록 함.
    ...
    private void SetTransparentPage()
    {
        ...
        SetWindowLong(hWnd, GWL_EXSTYLE, WS_EX_LAYERED); // 창의 속성을 부여하는 함수  - GWL_EXSTYLE: 현재 속성, WS_EX_LAYERED: 투명도 설정하는 플래그 부여
